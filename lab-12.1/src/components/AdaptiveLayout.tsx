  ...
  return (
    <View style={styles.container}>
      ...
      <View
        style={[
          styles.main,
          isLandscape ? styles.mainLandscape : null,
    ...
    <View style={[styles.statsRow, isTablet ? styles.statsRowTablet : null]}>
      {stats.map((stat, index) => (
        <View key={index} style={styles.statItem}>
          <Text
            style={[styles.statValue, isTablet ? styles.statValueTablet : null]}
          >
            {stat.value}
          </Text>
          <Text
            style={[styles.statLabel, isTablet ? styles.statLabelTablet : null]}
          >
            {stat.label}
          </Text>
        </View>
...
export function ResponsiveImage({ source: _source, style }: ResponsiveImageProps) {
  const { width } = useWindowDimensions();
