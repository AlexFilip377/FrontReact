            ...
            <View style={styles.content}>
                ...
                <View style={styles.actionsSection}>
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.navigate('Profile', { userId: '123' })}
                    >
                        <Text style={styles.primaryButtonText}>Посмотреть профиль</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                ...
                {unreadNotifications > 0 && (
                    <View style={styles.notificationBadge}>
                        <Text style={styles.notificationText}>
                            У вас {unreadNotifications} новых уведомлений.
                        </Text>
                    </View>
                )}
            </View>
...
const styles = StyleSheet.create({
    ...
    secondaryButton: {
        backgroundColor: "transparent", borderWidth: 1, borderColor: '#0066cc',
    ...
    notificationBadge: {
        ...
        marginTop: 20, borderLeftWidth: 4, borderLeftColor: '#ffc107',
    },
