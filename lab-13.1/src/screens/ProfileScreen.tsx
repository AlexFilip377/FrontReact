        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.infoSection}>
                    <Text style={styles.bioLabel}>Био</Text>
                    <Text style={styles.bio}>{profileData.bio}</Text>
                    <Text style={styles.infoLabel}>Зарегестрирован</Text>
...
const styles = StyleSheet.create({
  ...
  avatarPlaceholder: {
    width: 100, height: 100, borderRadius: 50, backgroundColor: '#0066cc',
  ...
  infoSection: { backgroundColor: '#ffffff', borderRadius: 12, padding: 20, marginBottom: 24 },
  bioLabel: { fontSize: 14, fontWeight: '600', color: '#333', marginBottom: 8 },
  bio: { fontSize: 14, color: '#666', lineHeight: 20, marginBottom: 16 },
  infoLabel: { fontSize: 12, color: '#999', marginBottom: 4, marginTop: 12 },
